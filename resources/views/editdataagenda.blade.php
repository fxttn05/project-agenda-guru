    ...
    <div class="card col-9 mt-3 rounded-3">
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="materi" value="{{$data->materi}}" class="form-control" id="exampleInputEmail1"
                    aria-describedby="emailHelp">
                @error('materi')
                <div class="text-danger">
                    {{$message}}
            ...
            <div class="mb-3">
                ...
                <input type="number" name="absensiswa" value="{{$data->absensiswa}}" class="form-control" id="exampleInputEmail1"
                    aria-describedby="emailHelp">
                @error('absensiswa')
                <div class="text-danger">
                    {{$message}}
