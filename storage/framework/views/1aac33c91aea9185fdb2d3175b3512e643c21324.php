...
<head>
    ...
    <title>Taruna Bhakti | <?php echo e($title); ?></title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                <div class="sidebar-brand-icon">
                    <img src="<?php echo e(asset ('/logo/logo.png')); ?>" alt="Logo TB" style="width: 2.5vw">
                </div>
                <div class="sidebar-brand-text mx-3">SMK Taruna Bhakti</div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Agenda 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
...
</html><?php /**PATH C:\applications\project-agenda-guru\resources\views/template.blade.php ENDPATH**/ ?>